    ...
    shuffledOptions.forEach((option, optIndex) => {
        ...
        if (!isAnswered) {
            optionButton.addEventListener('click', function () {
                ...
                if (isCorrect) {
                    this.style.backgroundColor = '#e1f2ec';
                    ...
                    this.style.borderColor = '#f04438';
                    this.style.color = '#f04438';

                    // Highlight correct answer
                    allOptions.forEach(opt => {
                        if (opt.dataset.correct === 'true') {
                            opt.style.backgroundColor = '#e1f2ec';
                ...
                rightItem.addEventListener('click', function () {
                    ...
                    if (leftItem) {
                        ...
                        if (isCorrect) {
                            ...
                            leftItem.style.borderColor = '#0d9488';
                            leftItem.style.backgroundColor = 'rgba(52, 211, 153, 0.1)';
                            leftItem.style.boxShadow = '0 0 0 2px #0d9488';

                            rightItem.style.borderColor = '#0d9488';
                            rightItem.style.backgroundColor = 'rgba(52, 211, 153, 0.1)';
                            rightItem.style.boxShadow = '0 0 0 2px #0d9488';
                            ...
                            leftItem.style.borderColor = '#f04438';
                            leftItem.style.boxShadow = '0 0 0 2px #f04438';
                            rightItem.style.borderColor = '#f04438';
                            rightItem.style.boxShadow = '0 0 0 2px #f04438';
